                            ...
                            @foreach($coupons as $coupon)
                                <tr id="coupon-row-{{ $coupon->id }}">
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <button class="btn btn-warning btn-sm edit-btn" data-id="{{ $coupon->id }}" data-code="{{ $coupon->code }}" data-discount="{{ $coupon->discount }}" data-expiry="{{ $coupon->expiry_date }}">Edit</button> <!-- Edit Button -->
